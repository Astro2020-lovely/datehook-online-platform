...
@section('content')
  <main class="app-content">
     <div class="app-title">
        <div>
           <h1><i class="fa fa-dashboard"></i> All Users Management</h1>
        </div>
     ...
     <div class="row">
        <div class="col-md-12">
          @if (count($users) == 0)
          <div class="tile">
            <h3 class="tile-title pull-left">Users List</h3>
                ...
                <table class="table">
                   ...
                   <tbody>
                     ...
                     <tr>
                        ...
                        <td data-label="Balance">{{round($user->balance, $gs->dec_pt)}} {{$gs->base_curr_text}}</td>
