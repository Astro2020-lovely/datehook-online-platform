...
@section('content')
  <main class="app-content">
     <div class="app-title">
        <div>
           <h1><i class="fa fa-dashboard"></i> Email Unverified Users Management</h1>
        </div>
     ...
     <div class="row">
        <div class="col-md-12">
          @if (count($emailUnverifiedUsers) == 0)
            <div class="tile">
              <h3 class="tile-title pull-left">Email Unverified Users List</h3>
              <div class="pull-right icon-btn">
                <form method="GET" class="form-inline" action="{{route('admin.emailUnverifiedUsersSearchResult')}}">
              ...
              <h2 class="text-center">NO EMAIL UNVERIFIED USERS FOUND</h2>
            </div>
          @else
            <div class="tile">
               <h3 class="tile-title pull-left">Email Unverified Users List</h3>
               ...
               <div class="table-responsive">
                  <table class="table">
                     ...
                     <tbody>
                       @foreach ($emailUnverifiedUsers as $user)
                         <tr>
               ...
               <div class="text-center">
                 {{$emailUnverifiedUsers->appends(['term' => $term])->links()}}
               </div>
            </div>
          @endif
        </div>
